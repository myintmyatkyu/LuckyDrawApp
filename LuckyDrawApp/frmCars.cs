    ...
    public partial class frmCars : Form
    {
        ...
        private void frmCars_Load(object sender, EventArgs e)
        {
            ...
            if (Screen.AllScreens.Length > 0)
            {
                ...
                //Screen primary = Screen.AllScreens.Where(i => i.Primary != true).ToList()[0];
                //Rectangle b = secondScreen.Bounds;
                //int x = Convert.ToInt32((b.Width * 0.098));
                //int y = Convert.ToInt32(b.Height * 0.505);
                //p1.Location = new Point(x, y);

                //lblWin1.Location = new Point(Convert.ToInt32(b.Width * 0.052), Convert.ToInt32(b.Height * 0.74));
            }
